function B = Bylgjujafna(L,T,N,M,gamma)
  ...
  % 0 0 C D E 0 0 ...
  % . . . . . . . ...
  % þar sem I er N+1 einingarfylki, 0 er núllfylki, B nálgar afleiðujöfnu
  % þegar t = T/M og C, D og E nálga afleiðujöfnur restina af leiðinni.
  % Ákveðin gildi eru þó ekki yfirskrifuð heldur eru pikkuð út þekkt fallgildi
  % í b vigrinum.
  for k=2:M
    for j=1:N-1
      i = (N+1)*k + (j+1);
